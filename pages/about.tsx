...
export const getServerSideProps = storeWrapper.getServerSideProps((store) => async ({ req }) => {
    try {
        ...
        const data: any = {
            events: [
                {id: 0, date: '2024-09-07', ephemerisTime: 778939269.1825322, title: 'Timeline becomes timeline wiki', content: `<p>In September 07, 2024, our major update ends. After the update, we will be serving timeline wiki.</p>`, isKeynote: 1, updatedDT: formatDate(getTodayDate()),  imagePath: "base-image.png", cdnUrl: "https://cdn.timeline.vg/", contributors: {counts: 1, userId: 0, username: 'you', imagePath: "base-image.png", cdnUrl: "https://cdn.timeline.vg/"}},
                {id: 1, date: '2024-09-01', ephemerisTime: 778420869.1826185, title: 'Event excluded from the keynote', content: `<p>This event is not as important as the event below. Thus, it is excluded from the keynote. You can include it into the keynote in event edit mode.</p>`, isKeynote: 0, updatedDT: formatDate(getTodayDate()),  imagePath: "base-image.png", cdnUrl: "https://cdn.timeline.vg/", contributors: {counts: 1, userId: 0, username: 'you', imagePath: "base-image.png", cdnUrl: "https://cdn.timeline.vg/"}}
            ],
