                        ...
                        return (
                            <>
                                <div key={timeline.id} className={'py-3'}>
                                    <div className={'font-semibold line-clamp-1'}>{timeline.name}</div>
                                    <div className={'flex gap-2'}>
                                        ...
                                        <div className={'relative w-[84px] h-[84px] shrink-0'}>
                                            {isBaseImage
                                                ? <>
                                                    <div className={'absolute bottom-[1px] w-[80px] h-[80px] rounded-md text-white flex items-center justify-center'}>
