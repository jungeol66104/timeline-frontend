...
export const getStaticProps = storeWrapper.getStaticProps((store) => async ({ params }) => {
    try {
        ...
        const data: any = {events: [], recentTimelines: recentTimelines, popularTimelines: popularTimelines, timelineInfo: {id: 0, name: "New Timeline Title", description: 'New timeline description', content: "Click 'Show more' below to write or fix content written in this space. ", image: 'https://cdn.timeline.vg/base-image.png'},}
