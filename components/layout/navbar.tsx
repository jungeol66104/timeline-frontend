...
import {selectCurrentDepth, selectIsTopEnd} from "@/store/slices/appearanceSlice";
...
const Navbar = () => {
    ...
    return (
        <div className={'fixed top-0 left-0 h-[60px] w-full bg-white pr-5 pl-5 shadow-md flex items-center justify-between'} style={{zIndex: 9999}}>
            <Link href={'/'} className={`font-black text-2xl transform transition-opacity ease-in-out duration-300`}>{navbarTitle}</Link>
