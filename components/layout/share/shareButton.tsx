...
const ShareButton = () => {
    ...
    return (
        <button ref={shareButtonRef} className={'block cursor-pointer w-full text-left'}>
            <div className={'px-3 py-1.5 h-[36px] bg-white hover:bg-gray-100 font-semibold'}>Share</div>
        </button>
    );
};
