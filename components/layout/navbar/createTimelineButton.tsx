...
const createTimelineButton = () => {
    return (
        <Link href={'/timelines/new'}>
            <div className={`flex items-center gap-1.5 pl-2 pr-3 h-[30px] max-[850px]:h-[36px] max-[850px]:w-full font-semibold min-[850px]:border-[0.1px] border-gray-300 bg-white hover:bg-gray-100 min-[850px]:drop-shadow-sm rounded-md`}>
