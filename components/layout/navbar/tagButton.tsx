...
const TagButton = ({tagNum}: {tagNum: number}) => {
    ...
    const tagAppearance = currentTag === 'Hot' ? <span>&#x1F525;  Hot</span> : currentTag === 'Staff Picks' ? <span>&#x2728;  Staff Picks</span> : currentTag === 'Popular' ? <span><span className={'text-[13px]'}>🏆</span> Popular</span> : <span>{currentTag}</span>;
