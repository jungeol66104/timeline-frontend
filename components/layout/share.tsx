...
const Share = () => {
    ...
    return (
        <div className={'share fixed px-5 w-full max-w-lg h-[170px] left-1/2 transform -translate-x-1/2 bg-white rounded-t-2xl flex flex-col items-center'} style={{zIndex:5002, bottom: bottom,  transition: 'bottom 0.3s'}}>
            <h2 className={'font-semibold text-md py-2.5'}>공유</h2>
            <div className={'w-full border-y-[1px] flex gap-[30px] py-5'}>
