...
const Popup = ({title, children}: {title: string, children: React.ReactNode}) => {
    ...
    return ReactDOM.createPortal(
        <div className={'fixed top-0 left-0 w-full h-full'}>
            ...
            <div className={'absolute overflow-y-hidden min-[416px]:w-[400px] max-[416px]:w-[calc(100%-16px)] min-[416px]:w-[400px] max-[416px]:w-[50%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl flex flex-col items-center'} style={{zIndex: 5003}}>
