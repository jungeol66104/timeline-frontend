...
const Toolbar = () => {
    return (
        <div className={'fixed bottom-[20px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-[190px] h-[40px] border-[1px] rounded-3xl bg-white drop-shadow-md'} style={{zIndex: 4999}}>
