    ...
    return (
        <div id={'editMorePopover'}
            ...
            <div className={'flex items-center gap-2'}>
                <div className={'pl-1.5 text-xs line-clamp-2'}>Select a thumbnail link displayed in timeline</div>
            ...
            <div className={'flex items-start gap-2'}>
                <div className={'pl-1.5 text-xs line-clamp-2'}>Check for showing the event in entry view</div>
                <KeynoteButton/>
            </div>
            <hr/>
            <div className={'flex items-start justify-between gap-2'}>
                <div className={'pl-1.5 text-xs line-clamp-2'}>Remove the event from the timeline</div>
                <DetachButton/>
            </div>
