...
import {selectEventContentType, updateEventContentType, updateModalType} from "@/store/slices/appearanceSlice";
...
const EventEditMenubar = ({editor}: {editor: Editor | null}) => {
    ...
    return (
        <div className={'editMenubar sticky bottom-3 w-full flex justify-between gap-3 z-30'}>
