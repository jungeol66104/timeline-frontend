...
const SectionSecondaryTest = () => {
    ...
    return (
        <div className={`relative w-full min-w-[300px] max-w-[402px] max-[928px]:max-w-[600px] ${!isBottomEnd && 'max-[928px]:hidden'} ml-2 max-[928px]:ml-0`}>
            <div className={'secondaryWrapper relative p-4 w-full h-fit min-w-[300px] max-w-[402px] max-[928px]:max-w-[600px] max-[928px]:py-0'}>
...
export default SectionSecondaryTest;
