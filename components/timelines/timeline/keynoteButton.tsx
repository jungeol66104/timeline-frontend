...
const KeynoteButton = () => {
    ...
    return (
        <div className={'relative'}>
            <button ref={keynoteButtonRef} onClick={handleToggle} className={`hover:bg-gray-100 pl-3 pr-1 w-[97px] h-[30px] flex items-center gap-1 bg-white border-[1px] border-gray-300 ${timelineType === 'demo' && demoKeyConcept === 'keynote' && 'outline outline-2 outline-blue-700'} rounded-md`}>
            ...
            {isToggle &&
                <div className={`absolute top-[32px] right-0 p-1 w-fit flex flex-col items-start bg-white border-[1px] border-gray-300 rounded-md shadow-md`}>
