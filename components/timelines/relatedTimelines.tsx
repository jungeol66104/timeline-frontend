...
const RelatedTimelines = () => {
    ...
    return (
        <div className={`${timelineType !== 'public' && 'hidden'} px-3 py-2 pr-0 flex flex-col gap-3 border-[1px] border-gray-300 rounded-lg`}>
            ...
            <div ref={swiperContainerRef} className={`relatedSwiper pr-3 flex gap-2 w-full overflow-x-scroll`}>
