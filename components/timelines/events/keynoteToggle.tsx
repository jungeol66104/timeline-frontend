...
const KeynoteToggle = () => {
    ...
    return (
        <button onClick={handleClick} className={`px-3 flex items-center justify-center gap-1.5 h-[36px] hover:bg-gray-100 rounded-md ${isKeynote && 'text-blue-700'} ${timelineType === 'demo' && demoKeyConcept === 'keynote' && 'outline outline-2 outline-blue-700'}`}>
