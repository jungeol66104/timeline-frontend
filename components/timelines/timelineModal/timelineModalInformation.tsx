...
const TimelineModalInformation = () => {
    ...
    return (
        <div className={'timelineModalInformation fixed w-full max-w-lg h-full left-1/2 transform -translate-x-1/2 bg-white rounded-t-2xl flex flex-col items-center'} style={{zIndex: 5002, height: 'calc(100% - 90px)', bottom: bottom, transition: 'bottom 0.3s'}}>
            ...
            <div className={'p-4 w-full h-full overflow-y-scroll'}>
                <div className={'w-full pb-3'}>
                    ...
                    <div className={'flex justify-end'}>
                        <button onClick={() => dispatch(updateIsEdit(true))}
                                className={`flex items-center gap-2.5 pl-1.5 pr-3 h-[30px] max-[850px]:h-[36px] font-semibold border-[0.1px] border-gray-300 bg-white hover:bg-gray-100 drop-shadow-sm rounded-md`}>
