...
const KeyConceptBar = () => {
    ...
    return (
        <div className={'flex gap-2 flex-wrap'}>
            ...
            <button onClick={() => handleClick('showMore')} className={`relative z-20 h-[32px] w-fit shrink-0 px-3 flex items-center justify-center rounded-3xl border-[1px] ${demoKeyConcept === 'showMore' ? 'border-black' : 'border-gray-300'} bg-white text-sm font-semibold hover:bg-gray-100`}>Show More</button>
