...
const Swiper = ({series}: {series: Series}) => {
    ...
    return (
        <div className={'swiper w-full max-w-[1004px] my-5 pl-5'}>
            ...
            <div ref={swiperContainerRef}  className={'swiperContainer hideScrollbar w-full max-w-[964px] flex gap-4 pb-2.5 mt-2.5 overflow-x-scroll'}>
...
// onMouseOver={() => handleHover(true)} onMouseLeave={() => handleHover(false)}
interface Series {
    id: number
    name: string
    description: string
