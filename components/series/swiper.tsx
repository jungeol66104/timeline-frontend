...
const Swiper = ({series}: {series: Series}) => {
    ...
    return (
        <div className={'swiper w-full max-w-[1004px] my-5 pl-5'}>
            ...
            <div ref={swiperContainerRef} onMouseOver={() => handleHover(true)} onMouseLeave={() => handleHover(false)} className={'swiperContainer h-fit w-full max-w-[964px] flex pb-2.5 mt-2.5 overflow-x-scroll'}>
                {/*hideScrollbar*/}
