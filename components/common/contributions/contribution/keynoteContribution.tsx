        ...
        <div className={'py-3 flex flex-col gap-3 border-b-[1px] border-[#E5E7EB]'}>
            <div className={'flex items-center justify-between'}>
                <div className={'flex items-center justify-center gap-3'}>
                    ...
                    <div>
                        <div className={'text-xs text-gray-500'}>Keynote</div>
            ...
            <div>
                ...
                <span className={'text-sm'}>{contribution.editHistoryType === 1 ? ' excluded from' : ' included into'} the keynote of the timeline </span>
