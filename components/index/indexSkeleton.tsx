...
const IndexSkeleton = () => {
    ...
    return (
        <div className={'page indexPage animate-pulse'}>
            <div className={`flex pt-2 pb-1.5 h-fit w-full border-b-[1px] border-gray-100 bg-white overflow-x-auto`}>
                <div className={'w-full flex gap-2 px-4'}>
                    ...
                    <div className={`h-[32px] w-fit px-3 flex items-center justify-center rounded-3xl border-[1px] bg-gray-100 shrink-0`}><span className={'text-gray-100'}>Popular</span></div>
                    <div className={`h-[32px] w-fit px-3 flex items-center justify-center rounded-3xl border-[1px] bg-gray-100 shrink-0`}><span className={'text-gray-100'}>Recently Added</span></div>
                </div>
            </div>
