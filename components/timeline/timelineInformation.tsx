            ...
            <div className={'mt-2.5'}>
                ...
                <div className={'min-h-[120px]'}>
                    <p className={`text-sm ${!showMore && 'line-clamp-5'}`}>
                         <span className={'font-medium'}>Muhammad bin Salman, born in 1985, is a prominent Saudi Arabian royal and politician, known for his ambitious reform agenda and his role as Crown Prince since 2017. </span>
