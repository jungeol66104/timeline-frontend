    ...
    return (
        <div className={'timelineInformation mb-4'}>
            ...
            <div className={'mt-2.5'}>
                <div className={'w-[100px] h-[100px] top-0 right-0 mb-[0.5px] shrink-0 float-right ml-2.5'}>
                    {isBaseImage
                        ? <>
                            <div
                                ...
                                <Image src={`/images/base-image/base-image${mapStrToNum(currentTimeline.name)}.jpg`}
                                       alt={'base-image'} width={144} height={144} priority={true}
