...
const Toolbar = () => {
    ...
    useEffect(() => {
        ...
        if (getClickOrTouch() === 'click') toolbar.classList.add('pr-8')
    }, []);


    return (
        <div className={`toolbar fixed bottom-[18px] flex items-center justify-end w-full max-w-[690px] pr-4`} style={{zIndex: 4998}}>
