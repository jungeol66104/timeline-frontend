...
const Toolbar = () => {
    ...
    useEffect(() => {
        ...
        if (getClickOrTouch() === 'touchend') toolbar.classList.add('pr-4')
    }, []);

    return (
        <div className={`toolbar fixed bottom-[18px] flex items-center justify-end w-full max-w-[638px]`} style={{zIndex: 4998, width: `calc(100% - 48px)`}}>
